...
('--food-menu-card-fundo',        'oklch(0.69 0.16 47.31)',           'oklch(0.69 0.16 47.31)',          '{-0.2435, 0.0607, -30.09}',      TRUE),
('--food-menu-card-escrita',      'oklch(1.00 0.00 0.00 / 1.00)',     'oklch(1.00 0.00 0.00 / 1.00)',     NULL,                            TRUE),
('--food-menu-escrita',           'oklch(1.00 0.00 0.00 / 1.00)',     'oklch(1.00 0.00 0.00 / 1.00)',     NULL,                            TRUE),
('--food-menu-fundo',             'oklch(0.1408 0.0044 285.82)',      'oklch(0.1408 0.0044 285.82)',      NULL,                            TRUE),
